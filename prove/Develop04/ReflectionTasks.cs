...
public class ReflectingTasks : Tasks
{
    // Attributes 
    ...
    // Constructors
    public ReflectingTasks(string tasksName, int tasksTime) : base(tasksName, tasksTime)
    {
    }
    // Methods
    ...
    private static void CountDwn(int seconds)
    {
